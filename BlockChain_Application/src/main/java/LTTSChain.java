...
public class LTTSChain {
    ...
    public static CaiVi CaiViA; //Ví A
    public static CaiVi CaiViB; //Ví B
    ...
    public static void main(String[] args) {
        ...
        CaiViA = new CaiVi();
        CaiViB = new CaiVi();
        CaiVi coinbase = new CaiVi();

        //Khởi tạo giao dịch gốc, để chuyển 100 Coin đến ví A CaiViA
        genesisTransaction = new Transaction(coinbase.publicKey, CaiViA.publicKey, 100f, null);
        ...
        System.out.println("\nSố dư của ví A là : " + CaiViA.getBalance());
        System.out.println("\nGiao dịch chuyển số tiền là 40 từ ví A đến ví B...");
        block1.addTransaction(CaiViA.sendFunds(CaiViB.publicKey, 40f));
        addBlock(block1);
        System.out.println("\nSố dư mới của ví A là : " + CaiViA.getBalance());
        System.out.println("Số dư của ví B là : " + CaiViB.getBalance());

        Block block2 = new Block(block1.hash);
        System.out.println("\nVí A gửi một số tiền nhiều hơn số tiền có trong ví...");
        block2.addTransaction(CaiViA.sendFunds(CaiViB.publicKey, 1000f));
        addBlock(block2);
        System.out.println("\nSố dư mới của ví A là : " + CaiViA.getBalance());
        System.out.println("Số dư mới của ví B là  " + CaiViB.getBalance());

        Block block3 = new Block(block2.hash);
        System.out.println("\nGiao dịch chuyển số tiền là 20 từ ví B đến ví A...");
        block3.addTransaction(CaiViB.sendFunds( CaiViA.publicKey, 20));
        System.out.println("\nSố dư mới của ví A là : " + CaiViA.getBalance());
        System.out.println("Số dư mới của ví B là  " + CaiViB.getBalance());
